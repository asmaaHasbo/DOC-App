...
class AppStyles {
  ...
  static TextStyle font14W500Grayc2 = TextStyle(
    fontSize: 14.sp,
    fontWeight: FontWeight.w500,
    color: AppColors.grayC2,
  );

  static TextStyle font12W400Gray9E = TextStyle(
    fontSize: 12.sp,
    fontWeight: FontWeight.w400,
    color: AppColors.gray9E,
  );

  static TextStyle font12W500Gray75 = TextStyle(
    fontSize: 12.sp,
    fontWeight: FontWeight.w500,
    color: AppColors.gray75,
  );

  static TextStyle font11W400Gray61 = TextStyle(
    fontSize: 11.sp,
    fontWeight: FontWeight.w400,
